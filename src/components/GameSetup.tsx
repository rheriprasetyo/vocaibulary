...
export const GameSetup: React.FC<GameSetupProps> = ({
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex flex-col px-4">
      ...
      <div className="w-full max-w-md mx-auto mt-4 mb-6">
        <div className="liquid-glass-card p-4 animate-fade-in">
          <div className="aspect-[9/16] w-full rounded-2xl overflow-hidden shadow-lg">
            <iframe
              src="https://www.youtube.com/embed/Ltyhh4uAxMU?si=pmzpmk8V-97JiKcG&autoplay=0&mute=1&controls=1&modestbranding=1&rel=0"
              title="VocAIbulary Demo"
          ...
          <div className="text-center mt-3">
            <p className="text-xs text-gray-600 font-light">Watch how VocAIbulary works</p>
          </div>
        </div>
      </div>
